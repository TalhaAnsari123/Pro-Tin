...
export default function Home() {
  return (
    <main className="relative w-full min-h-[100svh] flex items-start sm:items-center justify-center px-4 py-6 sm:py-12">
      ...
      <div className="relative w-full max-w-xl flex flex-col">
        <header className="mb-4 sm:mb-6 text-center shrink-0">
          ...
          <h1 className="text-2xl sm:text-4xl font-semibold tracking-tight text-gradient leading-tight">
            Protein Price Calculator
          </h1>
          <p className="mt-1.5 text-white/60 text-xs sm:text-sm">
            Compare cost per gram of protein across products.
          </p>
        </header>

        <Calculator />

        <footer className="mt-6 text-center text-[10px] sm:text-xs text-white/40 shrink-0">
          All values in $ — calculated and stored locally
        </footer>
      </div>
    </main>
  );
